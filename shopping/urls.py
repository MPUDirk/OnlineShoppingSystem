...
from .views import ProductListView, ProductCreateView, ProductDetailPageView, ProductUpdateView, ShoppingCartListView, CartItemCreateView, CartItemEditView, CartItemDeleteView
